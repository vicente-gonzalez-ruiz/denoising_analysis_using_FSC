...
\begin{enumerate}
\item \textbf{Quantization noise}, that is usually modeled as
  zero-mean uniform
...
\item \textbf{Thermal noise}, generally modeled as zero-mean Gaussian noise
